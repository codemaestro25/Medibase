...
import { addHospitalNewRecord, fetchIndiPersonalDetails } from "../../../services/api";
        ...
        <div className="container flex-grow-1">
          <form className="row g-3">
            ...
            <div className="col-md-4">
              ...
              <input type="text" className="form-control" disabled value={details?.name}/>
            </div>
            <div className="col-md-3">
              <label for="inputCity" className="form-label">
                Aadhar
              </label>
              <input type="text" className="form-control" id="inputCity" disabled value={details?.aadhar}/>
            </div>
            <div className="col-md-2">
              <label for="inputCity" className="form-label">
                DOB
              </label>
              <input type="text" className="form-control" id="inputCity" disabled value={details?.dob}/>
            </div>
            ...
            <div className="col-md-3">
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DemoContainer components={["DatePicker"]}>
                  <DatePicker label="Date Admitted" 
				   value={adDate}
            ...
            <div className="col-md-3">
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DemoContainer components={["DatePicker"]}>
                  <DatePicker label="Date Discharged" 
				  value={disDate}
            ...
            <div className="col-md-3 ">
              ...
              <input type="text" className="form-control " id="inputCity" value={"H1001"} disabled />
            </div>
            <div className="col-12">
